...
<tr>
<td><strong>Цели</strong></td>
<td><li>Пользователь: продлить лицензию для дальнейшего использования приложения;</li><li>Система: обновить данные о выбранной лицензии и сроке действия для пользователя</li></td>
</tr>
<tr>
<td><strong>Предыстория</strong></td>
<td>UC3 шаг 9а</td>
...
<tr>
<td><strong>Успешный сценарий</strong></td>
<td>1.1 Пользователь вводит Y;<br>1.2 Пользователь вводит N;<br> 2. Система проверяет введённый символ;</td>
</tr>
<tr>
<td><strong>Результат</strong></td>
...
<tr>
<td><strong>Расширения</strong></td>
<td>2а. Пользователь ввёл любые отличные от Y/y или N/n символы<br> Результат: отказ в переходе к дальнейшим шагам.<br>Система выдает сообщение <em><q>You entered a wrong symbol. Please choose Y for yes, N for no to continue</q></em><br>Переход на шаг 1.</td>
</tr>
</tbody>
</table>
<h2 id="uc-сохранение-истории">UC?? Сохранение истории</h2>
<table>
<thead>
<tr>
<th></th>
...
<tr>
<td><strong>Предыстория</strong></td>
<td>Пользователь запустил приложение и открыл файл</td>
</tr>
<tr>
<td><strong>Успешный сценарий</strong></td>
<td>1. Пользователь создаёт файл;<br> 2. Пользователь редактирует файл;<br>3. Пользователь сохраняет файл;<br>4. Система делает запись об изменении в базу данных;<br>5. Пользователь загружает предыдущую версию файла<br>6. Система получает данные об изменении;</td>
</tr>
<tr>
<td><strong>Результат</strong></td>
