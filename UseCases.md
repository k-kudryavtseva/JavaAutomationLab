...
<tr>
<td><strong>Успешный сценарий</strong></td>
<td>1. Пользователь вводит один из символов: Y или N;<br> 2. Система проверяет введённый символ;<br>3.1. Если пользователь ввёл  символ Y, система выдаёт сообщение: <em><q>Please choose license: 1 - for weeks, 2 - for months</q></em><br><ul>3.1.1. Пользователь вводит id выбранной лицензии<br>3.1.2. Система обновляет поля "license_id" ""</ul></td>
</tr>
<tr>
<td><strong>Результат</strong></td>
<td>аёт сообщение <em><q>Would you like to register? Enter Y - yes or N - no</q></em><br>/td&gt;
</td></tr>
<tr>
<td><strong>Расширения</strong></td>
<td>2а. Пользователь ввёл любые отличные от Y/y или N/n символы<br> Результат: отказ в переходе к дальнейшим шагам.<br>Система выдае оенentered a wrong symbol. Please choose Y for yes, N for no to continue<br>Переход на шаг 1.еходи ер а</td>
</tr>
</tbody>
</table>
